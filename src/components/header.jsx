...
const Header = async () => {
  ...
  return (
    <div className='flex flex-row container max-w-full items-center justify-center align-middle fixed z-50 bg-white shadow-[inset_0px_-1px_10px_rgba(0,0,0,0.1)] dark:bg-black dark:shadow-[inset_0px_-7px_10px_rgba(255,255,255,0.1)]'>
